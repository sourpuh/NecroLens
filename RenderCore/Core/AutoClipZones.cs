...
public class AutoClipZones
{
    ...
    {
        AtkUnitBase* addon = (AtkUnitBase*)Services.GameGui.GetAddonByName("_PartyList", 1);
    ...
    {
        AtkUnitBase* addon = (AtkUnitBase*)Services.GameGui.GetAddonByName("_TargetInfoCastBar", 1);
        if (addon == null || !addon->IsVisible) { return; }
    ...
    private unsafe void UpdateHotbarsClipRects()
    {
        ...
        {
            AtkUnitBase* addon = (AtkUnitBase*)Services.GameGui.GetAddonByName(addonName, 1);
    ...
    {
        AtkUnitBase* addon = (AtkUnitBase*)Services.GameGui.GetAddonByName("_MiniTalk", 1);
        if (addon == null || !addon->IsVisible) { return; }
